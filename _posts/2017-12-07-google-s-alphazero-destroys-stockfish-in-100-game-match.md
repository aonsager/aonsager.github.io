...
I think this means that the program just played a lot of chess games on its own, and learned for itself what positions and moves lead to more wins. Programs like Stockfish can't really plan ahead, which is why they need to check their tables for the best move each turn. AlphaZero must have this ability to look ahead. It can learn which moves don't pay off immediately but might give an advantage later. This ability makes the searches much more efficient:
